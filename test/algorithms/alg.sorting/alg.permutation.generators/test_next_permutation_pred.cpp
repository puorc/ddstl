...
namespace test_next_permutation_pred {
    ...
    test() {
        ...
        for (int e = 0; e <= sa; ++e) {
            ...
            do {
                ...
                x = ddstl::next_permutation(Iter(ia), Iter(ia + e), C());
                if (e > 1) {
                    if (x)
...
TEST_CASE("test std::next_permutation with pred", "") {
    using namespace test_next_permutation_pred;
