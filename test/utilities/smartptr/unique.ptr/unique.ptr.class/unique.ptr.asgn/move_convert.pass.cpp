...
namespace move_convert_pass
{
    ...
    using EnableIfNotSame = typename std::enable_if<
        !std::is_same<typename std::decay<T>::type, typename std::decay<U>::type>::value>::type;
    ...
    void doDeleterTest()
    {
        using U1 = ddstl::unique_ptr<VT, DDest>;
        using U2 = ddstl::unique_ptr<VT, DSource>;
    ...
    void test_sfinae()
    {
        ...
        { // Test that different non-reference deleter types are allowed so long
            ...
            using U1 = ddstl::unique_ptr<VT, GenericConvertingDeleter<0>>;
            using U2 = ddstl::unique_ptr<VT, GenericConvertingDeleter<1>>;
            static_assert(std::is_assignable<U1, U2 &&>::value, "");
        }
        { // Test that different non-reference deleter types are disallowed when
            // they cannot convert.
            using U1 = ddstl::unique_ptr<VT, GenericDeleter<0>>;
            using U2 = ddstl::unique_ptr<VT, GenericDeleter<1>>;
            static_assert(!std::is_assignable<U1, U2 &&>::value, "");
        }
        { // Test that if the deleter assignment is not valid the assignment operator
            // SFINAEs.
            using U1 = ddstl::unique_ptr<VT, GenericConvertingDeleter<0> const &>;
            using U2 = ddstl::unique_ptr<VT, GenericConvertingDeleter<0>>;
            using U3 = ddstl::unique_ptr<VT, GenericConvertingDeleter<0> &>;
            using U4 = ddstl::unique_ptr<VT, GenericConvertingDeleter<1>>;
            using U5 = ddstl::unique_ptr<VT, GenericConvertingDeleter<1> const &>;
            static_assert(!std::is_assignable<U1, U2 &&>::value, "");
            ...
            using U1C = ddstl::unique_ptr<const VT, GenericConvertingDeleter<0> const &>;
        ...
        { // Test that if the deleter assignment is not valid the assignment operator
            ...
            using U1C = ddstl::unique_ptr<const VT, GenericConvertingDeleter<0> &>;
            static_assert(std::is_nothrow_assignable<U1C, U1 &&>::value, "");
        }
        { // Test that non-reference destination deleters can be assigned
            ...
            using U1 = ddstl::unique_ptr<VT, GenericConvertingDeleter<0>>;
            using U2 = ddstl::unique_ptr<VT, GenericConvertingDeleter<0> &>;
            using U3 = ddstl::unique_ptr<VT, GenericConvertingDeleter<0> const &>;
            using U4 = ddstl::unique_ptr<VT, GenericConvertingDeleter<1>>;
            using U5 = ddstl::unique_ptr<VT, GenericConvertingDeleter<1> &>;
            using U6 = ddstl::unique_ptr<VT, GenericConvertingDeleter<1> const &>;
            static_assert(std::is_assignable<U1, U2 &&>::value, "");
            static_assert(std::is_assignable<U1, U3 &&>::value, "");
            static_assert(std::is_assignable<U1, U4 &&>::value, "");
            static_assert(std::is_assignable<U1, U5 &&>::value, "");
    ...
    void test_noexcept()
    {
        typedef typename std::conditional<IsArray, A[], A>::type VT;
        {
            typedef ddstl::unique_ptr<const VT> APtr;
            typedef ddstl::unique_ptr<VT> BPtr;
            static_assert(std::is_nothrow_assignable<APtr, BPtr>::value, "");
        }
        {
            typedef ddstl::unique_ptr<const VT, CDeleter<const VT>> APtr;
            typedef ddstl::unique_ptr<VT, CDeleter<VT>> BPtr;
            static_assert(std::is_nothrow_assignable<APtr, BPtr>::value, "");
        }
        {
            typedef ddstl::unique_ptr<const VT, NCDeleter<const VT> &> APtr;
            typedef ddstl::unique_ptr<VT, NCDeleter<const VT> &> BPtr;
            static_assert(std::is_nothrow_assignable<APtr, BPtr>::value, "");
        }
        {
            typedef ddstl::unique_ptr<const VT, const NCConstDeleter<const VT> &> APtr;
            typedef ddstl::unique_ptr<VT, const NCConstDeleter<const VT> &> BPtr;
            static_assert(std::is_nothrow_assignable<APtr, BPtr>::value, "");
        }
    }
    ...
    void test_deleter_value_category()
    {
        ...
        { // Test non-reference deleter conversions
            using U1 = ddstl::unique_ptr<VT, TD1>;
            using U2 = ddstl::unique_ptr<VT, TD2>;
            U1 u1;
            U2 u2;
        ...
        { // Test assignment to const&.
            using U1 = ddstl::unique_ptr<VT, CD1 const &>;
            using U2 = ddstl::unique_ptr<VT, CD2>;
            U1 u1(nullptr, cd1);
            U2 u2;
            u1.get_deleter().reset();
            u1 = std::move(u2);
        ...
        { // Test assignment from const ref
            using U1 = ddstl::unique_ptr<VT, TD1>;
            using U2 = ddstl::unique_ptr<VT, TD2 const &>;
            U1 u1;
            U2 u2(nullptr, d2);
            u1.get_deleter().reset();
            u1 = std::move(u2);
        ...
        { // Test assignment from const ref
            using U1 = ddstl::unique_ptr<VT, CD1 const &>;
            using U2 = ddstl::unique_ptr<VT, CD2 const &>;
            U1 u1(nullptr, cd1);
            U2 u2(nullptr, cd2);
            u1.get_deleter().reset();
            u1 = std::move(u2);
...
TEST_CASE("test unique ptr move convert pass", "")
{
    using namespace move_convert_pass;
    {
