...
public:
    ...
    TEST_CONSTEXPR_CXX14 output_iterator &operator++() {
        ++it_;
        return *this;
    }
...
class input_iterator {
    ...
    template<class U, class T> friend
    class input_iterator;
...
public:
    ...
    TEST_CONSTEXPR_CXX14 input_iterator &operator++() {
        ++it_;
        return *this;
    }
    ...
    friend TEST_CONSTEXPR_CXX14 bool operator!=(const input_iterator &x, const input_iterator &y) { return !(x == y); }
...
public:
    ...
    TEST_CONSTEXPR_CXX14 forward_iterator &operator++() {
        ++it_;
        return *this;
    }
...
public:
    ...
    TEST_CONSTEXPR_CXX14 bidirectional_iterator &operator++() {
        ++it_;
        return *this;
    }
...
public:
    ...
    TEST_CONSTEXPR_CXX14 random_access_iterator &operator+=(difference_type n) {
        it_ += n;
        return *this;
    }
...
struct ThrowingIterator {
    ...
    enum ThrowingAction {
        TAIncrement, TADecrement, TADereference, TAAssignment, TAComparison
    };
...
template<typename T>
bool operator==(const ThrowingIterator<T> &a, const ThrowingIterator<T> &b) { return a.operator==(b); }
