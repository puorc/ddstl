...
namespace test_pair_default_sfinae
{
#if TEST_STD_VER > 11
...
#define STATIC_ASSERT_CXX14(Pred) assert(Pred)
    ...
    struct DeletedDefault
    {
        ...
        // on ddstl::pair's default constructor.
    ...
    struct DefaultSFINAES
    {
        template <bool Dummy = false, class = typename std::enable_if<
                                          DependantIsDefault<T, Dummy>::value>::type>
    ...
    {
        {
            typedef ddstl::pair<IllFormedDefault, int> P;
        ...
        {
            typedef ddstl::pair<int, IllFormedDefault> P;
        ...
        {
            typedef ddstl::pair<IllFormedDefault, IllFormedDefault> P;
...
TEST_CASE("test pair test_default_sfinae")
{
    using namespace test_pair_default_sfinae;
    {
