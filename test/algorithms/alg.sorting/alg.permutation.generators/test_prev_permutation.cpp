...
namespace test_prev_permutation {
    ...
    test() {
        ...
        for (int e = 0; e <= sa; ++e) {
            ...
            do {
                ...
                x = ddstl::prev_permutation(Iter(ia), Iter(ia + e));
                if (e > 1) {
                    if (x)
...
TEST_CASE("test std::prev_permutation pass", "") {
    using namespace test_prev_permutation;
