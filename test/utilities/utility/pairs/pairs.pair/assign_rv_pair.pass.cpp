...
namespace test_pair_assign_rv_pair
{
    struct CountAssign
    {
        int copied = 0;
    ...
    {
        {
            typedef ddstl::pair<ConstexprTestTypes::MoveOnly, int> P;
            P p1(3, 4);
            P p2;
            p2 = std::move(p1);
        ...
        {
            using P = ddstl::pair<int, ConstexprTestTypes::DefaultOnly>;
            static_assert(!std::is_move_assignable<P>::value, "");
        }
        {
            // The move decays to the copy constructor
            using P = ddstl::pair<CountAssign, ConstexprTestTypes::CopyOnly>;
            static_assert(std::is_move_assignable<P>::value, "");
            P p;
            P p2;
            p = std::move(p2);
        ...
        {
            using P = ddstl::pair<CountAssign, ConstexprTestTypes::MoveOnly>;
            static_assert(std::is_move_assignable<P>::value, "");
            P p;
            P p2;
            p = std::move(p2);
        ...
        {
            using P1 = ddstl::pair<int, NotAssignable>;
            using P2 = ddstl::pair<NotAssignable, int>;
            using P3 = ddstl::pair<NotAssignable, NotAssignable>;
        ...
        }
        {
            ...
            using P1 = ddstl::pair<MoveAssignable &, int>;
            static_assert(!std::is_move_assignable<P1>::value, "");
            ...
            using P3 = ddstl::pair<MoveAssignable &&, int>;
            ...
            using P5 = ddstl::pair<NotAssignable &, int>;
            using P6 = ddstl::pair<NotAssignable &&, int>;
...
TEST_CASE("test pair assign rv pair")
{
    using namespace test_pair_assign_rv_pair;
    test();
#if TEST_STD_VER >= 20
    static_assert(test());
#endif
