...
namespace test_pair_assign_rv_pair_uv
{
    ...
    {
        {
            typedef ddstl::pair<Derived, short> P1;
            typedef ddstl::pair<ConstexprTestTypes::MoveOnly, long> P2;
        ...
        {
            using P = ddstl::pair<int, CountAssign>;
            using T = ddstl::pair<long, CountAssign>;
            T t(42, -42);
            P p(101, 101);
            p = std::move(t);
            assert(p.first == 42);
        ...
        }
        {
            ...
            using P1 = ddstl::pair<MoveAssignable, long>;
            using P2 = ddstl::pair<MoveAssignable &, int>;
            ...
            using P3 = ddstl::pair<MoveAssignable, long>;
            using P4 = ddstl::pair<MoveAssignable &&, int>;
        ...
        }
        {
            ...
            {
                using P1 = ddstl::pair<CopyAssignable &, long>;
                using P2 = ddstl::pair<CopyAssignable &, int>;
                static_assert(std::is_assignable<P1 &, P2 &&>::value, "");
            }
            ...
            // or CopyAssignable (since in the worst case the move will decay into a copy).
            {
                ...
                using P3 = ddstl::pair<CopyAssignable &&, long>;
                using P4 = ddstl::pair<CopyAssignable &&, int>;
                static_assert(std::is_assignable<P3 &, P4 &&>::value, "");
            }
            ...
            {
                using P1 = ddstl::pair<NotAssignable &, long>;
                using P2 = ddstl::pair<NotAssignable &, int>;
                static_assert(!std::is_assignable<P1 &, P2 &&>::value, "");

                using P3 = ddstl::pair<NotAssignable &&, long>;
                using P4 = ddstl::pair<NotAssignable &&, int>;
                static_assert(!std::is_assignable<P3 &, P4 &&>::value, "");
            }
        }
        return true;
...
TEST_CASE("test pair assign rv pair uv pass")
{
    using namespace test_pair_assign_rv_pair_uv;
    test();
#if TEST_STD_VER >= 20
    static_assert(test());
#endif
