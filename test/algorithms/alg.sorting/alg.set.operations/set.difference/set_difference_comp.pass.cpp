...
namespace test_set_difference_comp
{
    ...
    TEST_CONSTEXPR_CXX20 void test4()
    {
        ...
        const T b[] = {22, 32, 43, 42, 52};
        {
            T result[20] = {};
            T expected[] = {11, 31};
            OutIter end = ddstl::set_difference(Iter1(a), Iter1(a + 4), Iter2(b), Iter2(b + 5), OutIter(result), typename T::Comparator());
        ...
        }
        {
            T result[20] = {};
            T expected[] = {22, 42, 52};
            OutIter end = ddstl::set_difference(Iter1(b), Iter1(b + 5), Iter2(a), Iter2(a + 4), OutIter(result), typename T::Comparator());
...
TEST_CASE("test set_difference with cred pass")
{
    using namespace test_set_difference_comp;
    test();
#if TEST_STD_VER > 17
    static_assert(test());
#endif
