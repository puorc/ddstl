...
namespace test_pair_rv_pair_uv
{
    ...
    void test_pair_rv()
    {
        ...
        using UP1 = ddstl::pair<U1, int> &&;
        using UP2 = ddstl::pair<int, U1> &&;
    ...
    struct DPair : public ddstl::pair<T, U>
    {
        using Base = ddstl::pair<T, U>;
        using Base::Base;
    };
...
TEST_CASE("test pair rv_pair UV pass")
{
    using namespace test_pair_rv_pair_uv;
    {
        typedef ddstl::pair<std::unique_ptr<Derived>, int> P1;
        typedef ddstl::pair<std::unique_ptr<Base>, long> P2;
    ...
    //         {
    //             using P1 = ddstl::pair<NotCopyOrMoveConstructible &, long>;
    //     using P2 = ddstl::pair<NotCopyOrMoveConstructible &, int>;
    ...
    //     using P1 = ddstl::pair<NonCopyConstructible, long>;
    //     using P2 = ddstl::pair<NonCopyConstructible &, int>;
    //     static_assert(!std::is_constructible<P1, P2 &&>::value, "");
    // }
    // #if TEST_STD_VER > 11
    // { // explicit constexpr test
    //     constexpr ddstl::pair<int, int> p1(42, 43);
    //     constexpr ddstl::pair<ExplicitT, ExplicitT> p2(std::move(p1));
    //     static_assert(p2.first.value == 42, "");
    //     static_assert(p2.second.value == 43, "");
    // }
    // { // implicit constexpr test
    //     constexpr ddstl::pair<int, int> p1(42, 43);
    //     constexpr ddstl::pair<ImplicitT, ImplicitT> p2 = std::move(p1);
    //     static_assert(p2.first.value == 42, "");
    //     static_assert(p2.second.value == 43, "");
    // }
    // #endif
