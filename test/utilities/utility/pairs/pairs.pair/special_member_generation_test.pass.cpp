...
// namespace test_special_member_generation_test
// {
...
// TEST_CASE("test pair special_member_generation_test pass")
// {
//     using namespace test_special_member_generation_test;
